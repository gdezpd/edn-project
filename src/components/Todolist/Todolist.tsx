    ...
    <div>
      ...
      >
        <Card
          ...
          extra={
            <Button icon={<DeleteOutlined />} onClick={removeTodolistHandler} />
          }
          size='default'
        >
          ...
          <div style={{ paddingTop: '10px' }}>
            <Space className='site-button-ghost-wrapper' wrap>
              <Button
                type={filter === 'all' ? 'dashed' : 'default'}
                onClick={onAllClickHandler}
              >
                All
              </Button>
              <Button
                type={filter === 'active' ? 'dashed' : 'default'}
                onClick={onActiveClickHandler}
              >
                Active
              </Button>
              <Button
                type={filter === 'completed' ? 'dashed' : 'default'}
